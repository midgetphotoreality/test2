AZM.view.Menu = (function() {
	...
	var _init = function() {
		Core.debug.log("AZM.view.Menu -> _init()");
	...
	var onBtnOverzichtsplattegrond = function(event) {
		...
		Core.debug.log("AZM.view.Menu -> onBtnOverzichtsplattegrond()");
		Core.managers.NavigationManager.showAsset(AZM.Setup.content.Overzichtsplattegrond);
	}
	...
	var _show = function() {
		Core.debug.log("AZM.view.Menu -> _show()");
	...
	var _hide = function(callback) {
		Core.debug.log("AZM.view.Menu -> _hide()");
	...
	var _remove = function() {
		Core.debug.log("AZM.view.Menu -> _remove()");
		AZM.Setup.content.Menu.removeView(AZM.view.Menu);
		_divAsset = null;
	}
...
AZM.Setup.content.Menu.addView(AZM.view.Menu);